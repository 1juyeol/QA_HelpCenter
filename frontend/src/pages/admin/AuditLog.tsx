...
//   admin_login / admin_login_failed, collection_toggle, gemma_url_change,
...
//   jira_cache_refresh(수동 /api/jira/sync + 자동, 자동화 관리에서 시각 설정),
...
const ACTION_LABEL: Record<string, string> = {
  ...
  jira_cache_refresh: 'JIRA 버그 캐시 갱신',
  jira_cache_refresh_skipped: 'JIRA 버그 캐시 갱신 건너뜀',
...
const ACTION_CATEGORY: Record<string, Category> = {
  ...
  jira_cache_refresh: 'report',
  jira_cache_refresh_skipped: 'report',
