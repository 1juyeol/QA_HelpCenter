...
// *해지요청 사유 필드가 있는 CS 메모만 사유별로 묶어 보여준다 (필드 없는 메모는 사유가
// 이질적인 자유 텍스트라 집계에서 제외 — 전체 해지·유지 상담 중 일부만 대상).
// 각 사유 카드를 클릭하면 실제 CS 메모 원문을 펼쳐서 확인할 수 있다.
    ...
    <div className="qi-page">
      <div className="qi-head">
        ...
        <div className="qi-head-text">
          <h1>해지 사유 분석</h1>
          <p>
            "해지·유지 상담" 카테고리 중 상담원이 *해지요청 사유 필드에 이유를 남긴 건만 모아 사유별로 묶었어요.
            필드가 없는 나머지는 요청만 전달되고 이유가 기록되지 않은 경우라 집계에서 제외했습니다.
          </p>
        </div>
